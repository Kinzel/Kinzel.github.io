...
![](/images/todoslogos.png){width=400px}
</center>
...
Vídeo de X minutos, explicando todo o processo de instalação [aqui](linkdovideo).
...
A migração para *socket* e MetaTrader 5 foi custosa mas valeu a pena, era um tremendo *edge* acima dos outros investidores: eu tinha acesso em tempo-real para os meus modelos e histórico de preço dos ativos da corretora. Podia acompanhar a quantidade que eu quisesse de ações, fazer *grid* de todas as opções, calcular volatilidade implícita, acessar o *book* de ofertas, acompanhar mercado externo com outras *features* do R e acima de tudo, dava para lançar, modificar e excluir ordens. **Tudo em tempo real**. Um mundo se abriu!

E por que disponibilizá-lo? Muito do que hoje aprendi foram de pessoas anônimas, eu tive o prazer de dividir espaço com pessoas talentosíssimas no *MicroMasters* do MIT e o `mt5R` é uma das minhas formas de se doar ao mundo. Todos os códigos-fontes estão disponíveis e todo esse processo descrito acima, eu espero que menos pessoas tenham que cruzá-lo. Use-o com sabedoria e bons negócios!
